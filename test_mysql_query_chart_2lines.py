# mysql connect, query, plot
# by Jess Valdez
# Anyone is welcome to use it if useful to you.
...
print("Connected to battery Database.")
cursor = cnx.cursor()

query = ("SELECT runtime, Vbat_sw, Vbat_ocv FROM discharge_lfs "
         "WHERE runtime BETWEEN %s AND %s AND tdate like '2015-12-09'")
